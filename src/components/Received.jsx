...
//   // Fetch orders for logged-in user with status "received"
//   useEffect(() => {
//     async function fetchOrders() {
//       if (!session) {
//         setOrders([]);
...
//       if (error) {
//         console.error("Error fetching orders:", error);
//         setPopupMsg("Failed to load received orders");
//         setOrders([]);
//       } else {
//         setOrders(data);
//         setPopupMsg("");
...
//           <h2 className="text-xl mb-4">Please login to see your received orders</h2>
//           <button
//             onClick={signIn}
      ...
      {!session ? (
        <div className="text-center py-10">
          <h2 className="text-xl mb-4">
            Please login to see your received orders
          </h2>
          <button
            onClick={signIn}
            className="px-4 py-2 cursor-pointer bg-blue-600 text-white rounded hover:bg-blue-700"
            ...
            {isLoading ? (
              ...
              <div className="bg-white rounded-lg sm:rounded-xl shadow-md p-6 sm:p-8 text-center max-w-md mx-auto">
                <svg
                  ...
                  className="h-12 sm:h-16 w-12 sm:w-16 mx-auto text-gray-400"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <h3 className="text-lg sm:text-xl font-medium text-gray-700 mt-3 sm:mt-4">
                  No received orders
                </h3>
              ...
              <div className="flex justify-center">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
                  {orders.map((order) => (
                    <div
                      key={order.id}
                      className="bg-[#f9f3ef] rounded-lg sm:rounded-xl shadow-md sm:shadow-lg overflow-hidden flex flex-col"
                    >
                      {/* Product Image */}
                      <div className="p-3 sm:p-4 bg-[#f9f3ef] flex justify-center">
                        <img
                      ...
                      <div className="p-4 sm:p-6 flex-grow">
                        ...
                        <div className="my-4 ">
                          <span className="bg-green-100   text-green-800  text-xs sm:text-sm font-semibold px-2  py-0.5 rounded-full">
                          Delivered
                        </span>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm sm:text-base font-bold text-gray-800">
                              Rs.{" "}
                              {(order.products?.price * order.quantity).toFixed(
                                2
                              )}
                            </p>
                          </div>
                        ...
                        <div className="bg-green-50 border-l-4 border-green-400 p-3 sm:p-4 rounded-r">
                          <div className="flex items-start">
                            <svg
                              className="h-4 w-4 sm:h-5 sm:w-5 text-green-400 flex-shrink-0 mt-0.5"
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 20 20"
                              fill="currentColor"
                            >
                            ...
                            <p className="text-sm sm:text-sm text-green-700 ml-2">
                              Successfully delivered
                            </p>
                          </div>
                        </div>
