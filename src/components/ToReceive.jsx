      ...
      <div className="max-w-7xl mx-auto py-8 sm:py-12">
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-lg sm:rounded-xl shadow-md p-6 sm:p-8 text-center max-w-md mx-auto">
            ...
            <h3 className="text-lg sm:text-xl font-medium text-gray-700 mt-3 sm:mt-4">No orders to receive</h3>
            <p className="text-gray-500 mt-1 sm:mt-2 text-sm sm:text-base">Your confirmed orders will appear here</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {orders.map((order) => (
              <div key={order.id} className="bg-white rounded-lg sm:rounded-xl shadow-md sm:shadow-lg overflow-hidden flex flex-col">
                {/* Product Image */}
                ...
                {/* Order Details */}
                <div className="p-4 sm:p-6 bg-[#f9f3ef] flex-grow">
                  ...
                  <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 sm:h-4 sm:w-4 ml-1 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                      </div>
                    </div>
                  ...
                  <p className="text-xs sm:text-sm text-gray-500 mb-1">Order placed on:</p>
                  ...
                  <div className="p-3 sm:p-4 mb-3 sm:mb-4 bg-orange-50 rounded-lg">
                ...
                {/* Action Button */}
                <div className="px-4 sm:px-6 py-3 sm:py-4 bg-[#e7fdcc] border-t border-gray-200">
                  <button
                    onClick={() => confirmOrder(order.id)}
                    className="w-full bg-gradient-to-r from-[#94ce4c] to-[#5baf2f] hover:from-[#83bd3b] hover:to-[#4a9f1f] text-white font-semibold py-2 px-4 rounded-md sm:rounded-lg transition-all text-sm sm:text-base"
                  >
                    Mark as Received
                  </button>
                </div>
