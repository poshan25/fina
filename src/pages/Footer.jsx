...
const Footer = () => {
  return (
    <footer className="bg-[#ffff] text-gray-800 pt-12 pb-7">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Top grid - Logo/About/Social + Categories + Help + Useful Links */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand/Info/Social */}
          <div>
            <div className="mb-3 flex items-center md:block justify-center">
              <img
                src="/images/mainLogo.png" // Change to your logo path
                alt="Meonara Organics Logo"
                width={140}
                height={87}
            ...
            <div className="text-sm text-gray-700 mb-4">
              Meonara Organics, founded to empower your natural beauty. As Nepal's trusted organic beauty platform, we offer a curated selection of premium, sustainable products. Shop genuine, high-quality beauty with confidence and care.
            </div>
            <div className="flex items-center space-x-4 mt-3">
              ...
              >
                <FaInstagram className="w-7 h-7 text-[#E1306C]" />
              </a>
              <a
          ...
          <div>
            ...
            <div className="flex flex-col gap-1 text-sm">
              <Link to="/category/korean-beauty" className="hover:text-[#DD346C]">Korean Beauty</Link>
              <Link to="/category/others" className="hover:text-[#DD346C]">Others</Link>
              <Link to="/category/makeup" className="hover:text-[#DD346C]">Makeup</Link>
              <Link to="/category/skincare" className="hover:text-[#DD346C]">Skincare</Link>
              <Link to="/category/haircare" className="hover:text-[#DD346C]">Haircare</Link>
              <Link to="/category/body" className="hover:text-[#DD346C]">Body</Link>
              <Link to="/category/essentials" className="hover:text-[#DD346C]">Essentials</Link>
              <Link to="/category/hands-feet" className="hover:text-[#DD346C]">Hands &amp; Feet</Link>
              <Link to="/category/wellness" className="hover:text-[#DD346C]">Wellness</Link>
            </div>
          </div>
          {/* Help & Support */}
          <div>
            <div className="font-bold text-lg mb-3">Help &amp; Support</div>
            <div className="flex flex-col gap-1 text-sm">
              <Link to="/contact-us" className="hover:text-[#DD346C]">Contact Us</Link>
              <Link to="/FAQs" className="hover:text-[#DD346C]">Frequently Asked Questions</Link>
              <Link to="/shipping-policy" className="hover:text-[#DD346C]">Shipping &amp; Delivery</Link>
            </div>
          </div>
          {/* Useful Links */}
          <div>
            <div className="font-bold text-lg mb-3">Useful Links</div>
            <div className="flex flex-col gap-1 text-sm">
              <Link to="/about-us" className="hover:text-[#DD346C]">Who are we?</Link>
              <Link to="/reviews" className="hover:text-[#DD346C]">Reviews</Link>
              <Link to="/terms-and-conditions" className="hover:text-[#DD346C]">Terms and Conditions</Link>
              <Link to="/privacy-policy" className="hover:text-[#DD346C]">Privacy Policy</Link>
            </div>
          </div>
        </div>
        {/* Divider */}
        ...
        <div className="flex flex-col md:flex-row md:justify-between items-center gap-2">
          <div className="text-sm text-gray-600">
            &copy; {new Date().getFullYear()} meonaraorganics.com | All Rights Reserved
          </div>
          <div className="text-xs text-gray-500 opacity-70 flex flex-wrap gap-2 md:gap-4">
        ...
        <div className="mt-6 text-center">
          <Link
            className="inline-block border p-2 rounded-xl bg-blue-500 border-none text-gray-100 hover:bg-blue-600 transition"
            to="/becomeseller"
          >
            Become A Seller
          </Link>
