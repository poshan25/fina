...
//             {/* About Section */}
//             <div>
//               <h3 className="text-xl font-bold mb-4">finas Organics</h3>
...
//             <p>&copy; {new Date().getFullYear()} fina Organics. All rights reserved.</p>
//           </div>
//         </div>
//       </footer>
//   )
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-6 lg:gap-8">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-xl font-bold mb-4">fina Organics</h3>
